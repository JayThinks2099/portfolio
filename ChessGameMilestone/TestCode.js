...
const onClick = function() {
    ...
    var pieceColor = document.getElementById(this.id).innerHTML;
    document.getElementById("SLP").innerHTML = pieceColor;
...
var rankLoc = 7;
var rowLoc = 7;
var position = rank[rankLoc-1].concat(row[rowLoc-1]);
